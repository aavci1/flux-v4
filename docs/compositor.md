...
- Compare larger wlroots workflows that are not fully covered by narrow resource tests: remaining seat focus/grabs, deeper dynamic layer-shell behavior, and output-layout foundations.
