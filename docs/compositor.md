...
**Status:** initial polish work in progress. New toplevels now get a short compositor-side fade/scale-in animation.
...
- ◐ Window animations feel smooth (60+ FPS during animations, no jank). Initial open animation is implemented; close/move/resize/snap animations remain pending.
...
| Phase 5: Animation + polish | Initial polish in progress | 2026-05-17 | - | New toplevels fade/scale in; close/move/resize/snap animation, configuration, hardware cursor, frame timing, wallpaper, and docs remain pending. |
