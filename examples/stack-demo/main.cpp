// Showcases VStack (vertical) and HStack (horizontal) layout: spacing, alignment, nesting, and Spacer.
#include <Flux.hpp>
                    ...
                    .children =
                        {
                            ...
                            Text{.text = "Nested — HStack rows inside a VStack",
                                 .font = {.size = 15.f, .weight = 600.f},
                                 .color = pal::ink},
                            VStack{
                                .spacing = 8.f,
                            ...
                            Text{.text = "HStack + Spacer (flex along the row)",
                                 .font = {.size = 15.f, .weight = 600.f},
                                 .color = pal::ink},
                            HStack{
                                .spacing = 0.f,
