...
- [ ] [Auto] Re-run macOS compile/focused tests for the latest Metal review fixes; the earlier 2026-06-11 macOS run passed before the final Metal atlas/backdrop batches.
- [ ] [Auto + Manual] Complete remaining macOS runtime verification for FP-14/FP-16 and latest Metal fixes: `debug::perf`, full `ctest`, deferred atlas grow regression test, unicode-heavy editor paste, drawable wait counters, and backdrop-blur visual comparison.
