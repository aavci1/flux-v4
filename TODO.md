...
- [ ] [Manual] Complete the remaining hardware/visual checks from the plan: manual cursor/hardware input-driver checks, resize/drag visual checks, and representative app smoke checks requiring interactive input.
