...
TEST_CASE("Reactive2 Bindable stores plain values") {
...
TEST_CASE("Reactive2 Bindable stores reactive closures") {
  int source = 4;
...
TEST_CASE("Reactive2 Bindable works with Flux value types") {
